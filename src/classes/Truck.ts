...
class Truck extends Vehicle implements AbleToTow {
  ...
  constructor(
    ...
    // TODO: xThe constructor should check if the wheels array has 4 elements and create 4 new default Wheel objects if it does not
    if (wheels.length !== 4) {
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    // xTODO: Get the make and model of the vehicle if it exists
